...
export default function Register() {
    ...
    return (
        <>
            ...
            <div className="sm:w-full lg:w-1/2 mx-auto shadow-2xl p-12 my-8 ">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input
                        ...
                        className="w-full px-3 text-white my-3 border-2 rounded-2xl outline-0 py-2  placeholder:text-gray-400 border-gray-200 "
                    />
                    {errors.dateOfBirth && (
                        <p className="p-2 bg-red-500 text-white rounded-2xl text-center">
                    ...
                    <div className="gender my-3 flex justify-start items-center gap-4">
                        <div className="male">
                            <input
                                {...register("gender")}
                                type="radio"
                        ...
                        <div className="female">
                            <input
                                ...
                                value="female"
                            />
                            <label className="text-white me-4" htmlFor="female">
                                female
                            </label>
                        </div>
                    </div>
